<?php
/**
* @version $Id: mod_vtiger.php,v 1.2 2005/03/09 23:59:01 clint Exp $
* @package Joomla
* @copyright (C) 2006 - 2010 FOSS Labs
* @license http://www.gnu.org/copyleft/gpl.html GNU/GPL
* Mambo is Free Software
* Contributor:  FOSS Labs
* Portions created by FOSS Labs (C) 2006 FOSS Labs
*/
...
if ( $my->id ) {
	...
	<tr>
		<td>
		<a href="<?php echo sefRelToAbs( 'index.php?option=com_vtigerregistration&amp;task=lostPassword' ); ?>">
	...
	<tr>
		...
		<a href="<?php echo sefRelToAbs( 'index.php?option=com_vtigerregistration&amp;task=register' ); ?>">
