<?php
/**
* @version $Id: toolbar.vtigersalesorders.html.php 85 2006-07-10 23:12:03Z mmbrich $
* @package Joomla
* @subpackage Vtiger Sales Orders
...
class HTML_vtigersalesorders {
        ...
        ?>
                ...
                <tr>
                        <th>
                        About Vtiger Sales Orders for Joomla!
                        </th>
                </tr>
                <tr>
                        <td>
                                The Vtiger Sales Order component for Joomla! was originally created by <a href="http://www.fosslabs.com">FOSS Labs</a><br>
                                <br>Contributors:<br>
        ...
        ?>
                ...
                <input type="hidden" name="name" value="Salesorders" />
                <input type="hidden" name="admin_menu_link" value="option=com_vtigersalesorders" />
                <input type="hidden" name="admin_menu_alt" value="Manage Sales Order Settings" />
                <input type="hidden" name="option" value="com_vtigersalesorders" />
