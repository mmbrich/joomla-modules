<?php
/**
* @version $Id: toolbar.vtigerproducts.html.php 85 2006-07-10 23:12:03Z mmbrich $
* @package Joomla
...
function settings($option) {
        ...
        HTML_vtigersalesorders::settings($option,$current_config);
}
?>
